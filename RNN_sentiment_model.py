...
embedding_dim = 128          # Dimension for embedding layers
...
comment_masked = layers.Masking(mask_value=tokenizer.pad_token_id)(comment_embedding)
post_masked = layers.Masking(mask_value=tokenizer.pad_token_id)(post_embedding)
...
model = models.Model(inputs=[input_comment, input_post], outputs=outputs)
...
#save the model.
model.save("sentiment_lstm_model2")
